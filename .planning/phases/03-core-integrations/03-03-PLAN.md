...
files_modified: []
autonomous: false
requirements: [CU-01, MAIL-01, MAIL-02, CAL-01, DRIVE-01, DRIVE-02]
user_setup: []
...
<task type="checkpoint:human-action" gate="blocking">
  ...
  **Step 6: Deploy and Restart**
  ...
  5. Verify no startup errors, confirm "ClickUp deadline monitor started" and "Calendar reminder monitor started" in logs
  </how-to-verify>
...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <action>All four integrations (ClickUp, Gmail, Google Calendar, Google Drive) have been configured and deployed via MCP in Plans 01 and 02. Proactive monitors (ClickUp deadlines, calendar reminders) are active. This task verifies real end-to-end data flows.</action>
  <what-built>All four integrations (ClickUp, Gmail, Google Calendar, Google Drive) configured and running via MCP. Proactive monitors (ClickUp deadlines, calendar reminders) active.</what-built>
  <how-to-verify>
  ...
  **Test 4: Google Drive (DRIVE-01, DRIVE-02)**
  ...
  **Test 7: Proactive alerts**
  If you have tasks with deadlines within 24h or meetings within 15 minutes: Check if notifications arrive automatically.
  </how-to-verify>
...
7. Proactive alerts dispatch for approaching deadlines / upcoming meetings
</verification>
...
- Proactive monitors actively dispatch notifications
