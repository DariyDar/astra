...
• Если в KB-контексте указана внутренняя структура проекта (напр. блоки: production, creatives, UA) — группируй буллеты внутри проекта по этим блокам, но БЕЗ префиксов.
